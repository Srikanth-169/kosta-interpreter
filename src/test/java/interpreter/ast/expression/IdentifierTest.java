...
public class IdentifierTest {
    ...
    public void testConstructor() {
        Token token = new com.github.konstantinevashalomidze.interpreter.token.types.Identifier().setLiteral("variable");
    ...
    public void testSetToken() {
        ...
        Token newToken = new com.github.konstantinevashalomidze.interpreter.token.types.Identifier().setLiteral("newVar");
